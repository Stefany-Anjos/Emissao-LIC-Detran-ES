        ...
        if not status_atual:
            ...
            try:
                ...
                try:
                    ...
                    botao_acessar = WebDriverWait(navegador, 1000).until(EC.element_to_be_clickable((By.XPATH, "/html/body/app-root/app-main/div/div/app-sidenav/div/div/div/app-servico-detalhe/div/div[2]/div/app-botao-acessar/div/button")).cl
