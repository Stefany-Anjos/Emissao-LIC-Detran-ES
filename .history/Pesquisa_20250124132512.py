        ...
        if not status_atual:
            ...
            while erro_captcha is False:
                ...
                with Image.open("screenshot.png") as img:
                    ...
                    print("CAPTCHA salvo como 'captcha_cropped.png'")
            ...
            try:
                ...
                while campo_lic != "Licenciamento Anual 2025":
                    campo_lic = navegador.find_element(By.CSS_SELECTOR, f"#LicenciamentoExercicio > table > tbody > tr:nth-child({id_linha})")
                    campo_lic = campo_lic.text
                    if campo_lic == "  Licenciamento Anual 2025":
                        break
    else:
        printrint("Placa já pesquisada")                                
finally:
    navegador.quit()
