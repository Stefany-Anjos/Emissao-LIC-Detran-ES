        ...
        if not status_atual:
            ...
            try:
                ...
                while botao_boleto != "Emitir Boleto":
                    botao_boleto = WebDriverWait(navegador, 10).until(EC.visibility_of_element_located((By.CSS_SELECTOR, f"#LicenciamentoExercicio > table > tbody > tr:nth-child({id_linha2}) > td > input[type=button]")))
                    id_linha2 += 1
                    if botao_boleto:
                        break
                    else:
                ...
                try:
                    ...
                    botao_acessar = WebDriverWait(navegador, 1000).until(EC.element_to_be_clickable)
