        ...
        if not status_atual:
            ...
            while erro_captcha is False:
                ...
                try:
                    ...
                    try:
                        tela_erroRenavam = WebDriverWait(navegador, 10).until(EC.visibility_of_element_located((By.CSS_SELECTOR)))
            ...
            try:
                ...
                while True:
                    try:
                        botao_boleto = WebDriverWait(navegador, 10).until(EC.element_to_be_clickable(
